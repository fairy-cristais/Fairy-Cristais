...
<body>
    <nav class="nav">
      ...
      <button class="menu"><img src="menu.png"></button>
			<a href="pag_principal.html" class="nav-button">Página Inicial</a>
      <a href="cadastro_clientes.php" class="nav-button">Realizar Login</a>
			<a href="sobre.html" class="nav-button">Conheça nossa loja</a>
